  ...
  render() {
    return (
        <div ref={ele => this.grid = ele} className="instruction">
          <textarea readOnly rows="10" cols="100" defaultValue={"Instructions:\n" +
          ...
          "Click start button to start the animation.\n" +
            "鼠标第一次单击选择起点、第二次单击选择终点. 鼠标拖拽创造障碍。\n" +
          "1. 点击 search and draw path 按钮能够找到一条路 \n" +
          "2. 点击 start animate 按钮，出现一个圆圈从起点移动到终点 \n" +
          "3. 如果不点击 2 步骤中的 start animate 按钮，点击 next step 按钮能够开始一步步的模拟\n" +
          "4. reset time step 按钮会重置圆圈到起点。\n"}>
        </textarea><br/>
